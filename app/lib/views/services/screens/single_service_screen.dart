...
class _SingleServiceScreenState extends State<SingleServiceScreen> {
  ...
  void initState() {
    ...
    mockBookingService = BookingService(
        serviceName: 'General Service Appointment',
        serviceDuration: 60,
  ...
  Future<dynamic> uploadBookingMock(
    ...
    print('Appointment ${newBooking.toJson()} has been booked successfully');
  }
      ...
      body: Center(
        child: BookingCalendar(
          ...
          wholeDayIsBookedWidget:
              const Text('Sorry, no appointments available for this day'),
